...
c=b?0<=b.indexOf("0")?z(a).format(b):k(new Date(a)).format(b):a:a.toString&&"function"===typeof a.toString&&(c=a.toString());return c},TRIM:function(a){return q.trim(a)},UNICHAR:function(a){return e.text.CHAR(a)},UNICODE:function(a){return e.text.CODE(a)},UPPER:function(a){return a.toUpperCase()},VALUE:function(a){return"undefined"==typeof z?"#NAME?":z().unformat(a)}},trigonometry:{},general:{VLOOKUP:function(a,b,c,d){var f,e;typeof("object"==b)&&"Object"==b.constructor.name&&(b=s.rangeToTable(b));
...
null===d[t][2]?[]:d[t][2];if(d[t][1]===k||0<=q.indexOf(k))g=d[t];if(d[t][1]===l||0<=q.indexOf(l))p=d[t]}if(null===g)for(q=f[b.substring(0,2)],t=e[b.substring(0,1)],"da"===b.substring(0,2)&&(t=["dekao",10,"da"]),q?(n=q[2],k=b.substring(2)):t&&(n=t[1],k=b.substring(t[2].length)),b=0;b<d.length;b++)if(q=null===d[b][2]?[]:d[b][2],d[b][1]===k||0<=q.indexOf(k))g=d[b];if(null===p)for(f=f[c.substring(0,2)],e=e[c.substring(0,1)],"da"===c.substring(0,2)&&(e=["dekao",10,"da"]),f?(s=f[2],l=c.substring(2)):e&&
(s=e[1],l=c.substring(e[2].length)),c=0;c<d.length;c++)if(q=null===d[c][2]?[]:d[c][2],d[c][1]===l||0<=q.indexOf(l))p=d[c];return null===g||null===p||g[3]!==p[3]?"#N/A":a*g[6]*n/(p[6]*s)},DEC2BIN:function(a,b){if(isNaN(a))return"#VALUE!";if(!/^-?[0-9]{1,3}$/.test(a)||-512>a||511<a)return"#NUM!";if(0>a)return"1"+s.repeat("0",9-(512+a).toString(2).length)+(512+a).toString(2);var c=parseInt(a,10).toString(2);if("undefined"===typeof b)return c;if(isNaN(b))return"#VALUE!";if(0>b)return"#NUM!";b=Math.floor(b);
...
l=q.trim(f[0]);k=f[1].split(":");f=q.trim(k[0]);k=q.trim(k[1]);f=this.sheet.getRemoteCellRange(l,f,k);n=q(l).attr("data-calx-identifier");if("undefined"==typeof n||"undefined"==typeof t.sheetRegistry[n])q(l).calx(),n=q(l).attr("data-calx-identifier");"undefined"!=typeof n&&"undefined"!=typeof t.sheetRegistry[n]&&(t.sheetRegistry[n].registerDependant(this.sheet),this.sheet.registerDependency(t.sheetRegistry[n]));for(g in f)k=l+"!"+g,"undefined"==typeof this.dependencies[k]&&!1!==f[g]&&(this.hasRemoteDependency(!0),
this.dependencies[k]=f[g],f[g].registerDependant(c+"!"+this.getAddress(),this))}break;case "remoteCell":for(d=0;d<m.length;d++)f=m[d].split("!"),l=q.trim(f[0]),k=q.trim(f[1]),f=this.sheet.getRemoteCell(l,k),n=q(l).attr("data-calx-identifier"),"undefined"!=typeof n&&"undefined"!=typeof t.sheetRegistry[n]||q(l).calx(),"undefined"!=typeof n&&"undefined"!=typeof t.sheetRegistry[n]&&(t.sheetRegistry[n].registerDependant(this.sheet),this.sheet.registerDependency(t.sheetRegistry[n])),k=l+"!"+k,"undefined"==
typeof this.dependencies[k]&&!1!==f&&(this.hasRemoteDependency(!0),this.dependencies[k]=f,f.registerDependant(c+"!"+this.getAddress(),this));break;case "cellRange":for(d=0;d<m.length;d++)for(g in k=m[d].split(":"),f=q.trim(k[0]),k=q.trim(k[1]),f=this.sheet.getCellRange(f,k),f)"undefined"==typeof this.dependencies[g]&&!1!==f[g]&&(this.dependencies[g]=f[g],f[g].registerDependant(this.getAddress(),this));break;case "cell":for(d=0;d<m.length;d++)k=m[d],f=this.sheet.getCell(k),"undefined"==typeof this.dependencies[k]&&
...
return this},reset:function(){return this.each(function(){var a=q(this).attr("data-calx-identifier");a&&"undefined"!=typeof t.sheetRegistry[a]&&t.sheetRegistry[a].reset()})},calculate:function(){return this.each(function(){var a=q(this).attr("data-calx-identifier");a&&"undefined"!=typeof t.sheetRegistry[a]&&t.sheetRegistry[a].calculate()})},setValue:function(a,b){var c=q(this).attr("data-calx-identifier"),c=t.sheetRegistry[c];c.getCell(a).setValue(b).renderComputedValue();c.config.autoCalculate&&
c.calculate()}};q.fn.calx=function(a,b){if(t[a])return t[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"==typeof a||"undefined"==typeof a)return t.init.apply(this,arguments);q.error("Method "+a+" does not exist on jQuery.calx")}})(jQuery,numeral,moment,jStat);
