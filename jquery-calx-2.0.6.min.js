...
delete s.sheetRegistry[b])});return this},reset:function(){return this.each(function(){var a=r(this).attr("data-calx-identifier");a&&"undefined"!=typeof s.sheetRegistry[a]&&s.sheetRegistry[a].reset()})},calculate:function(){return this.each(function(){var a=r(this).attr("data-calx-identifier");a&&"undefined"!=typeof s.sheetRegistry[a]&&s.sheetRegistry[a].calculate()})},setValue:function(a,b){var c=r(this).attr("data-calx-identifier"),c=s.sheetRegistry[c],d=c.getCell(a);d.setValue(b);d.processDependant();
c.renderComputedValue()}};r.fn.calx=function(a,b){if(s[a])return s[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"==typeof a||"undefined"==typeof a)return s.init.apply(this,arguments);r.error("Method "+a+" does not exist on jQuery.calx")}})(jQuery,numeral,moment,jStat);
