...
function(a){a=a[0];return"undefined"==typeof n.VARIABLE[a]?"#NAME?":n.VARIABLE[a]};t.fx.time=function(a){var b=a.split(":");a=new Date;var c="undefined"==typeof b[0]?0:b[0],d="undefined"==typeof b[1]?0:b[1],b="undefined"==typeof b[2]?0:b[2];return new Date(a.getFullYear(),a.getMonth(),a.getDate(),c,d,b)};t.fx.callFunction=function(a,b){var c,d;d=a.toUpperCase();if("function"==typeof e[d])return e[d].apply(this,b);for(c in e)if("function"==typeof e[c][d])return e[c][d].apply(this,b);return"#NAME?"};
t.fx.getRemoteCell=function(a,b){var c=p(a).attr("data-calx-identifier");return c&&"undefined"!=typeof s.sheetRegistry[c]?s.sheetRegistry[c].getCell(b):!1};t.fx.getRemoteCellRange=function(a,b,c){return(a=p(a).attr("data-calx-identifier"))&&"undefined"!=typeof s.sheetRegistry[a]?s.sheetRegistry[a].getCellRange(b,c):!1};t.fx.getRemoteCellValue=function(a,b){var c=p(a).attr("data-calx-identifier");return c&&"undefined"!=typeof s.sheetRegistry[c]?s.sheetRegistry[c].getCellValue(b):!1};t.fx.getRemoteCellRangeValue=
function(a,b,c){return(a=p(a).attr("data-calx-identifier"))&&"undefined"!=typeof s.sheetRegistry[a]?s.sheetRegistry[a].getCellRangeValue(b,c):!1};t.fx.getCellRangeValue=function(a,b){a=a.toUpperCase();b=b.toUpperCase();var c=q.cellRange(a,b),d=c.length,e={},g;for(g=0;g<d;g++)e[c[g]]=this.getCellValue(c[g]);return e};t.fx.getCellValue=function(a){a=a.toUpperCase();return"undefined"==typeof this.cells[a]?!1:this.cells[a].getValue()};t.fx.evaluate=function(a){return this.parser.parse(a)};t.fx.update=
