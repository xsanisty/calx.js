...
b=b.replace(a[e],""),null!==l)switch(e){case "remoteCellRange":for(d=0;d<l.length;d++)for(g in f=l[d].split("!"),m=r.trim(f[0]),h=f[1].split(":"),f=r.trim(h[0]),h=r.trim(h[1]),f=this.sheet.getRemoteCellRange(m,f,h),q=r(m).attr("data-calx-identifier"),"undefined"!=typeof q&&"undefined"!=typeof s.sheetRegistry[q]&&(s.sheetRegistry[q].registerDependant(this.sheet),this.sheet.registerDependency(s.sheetRegistry[q])),f)h=m+"!"+g,"undefined"==typeof this.dependencies[h]&&!1!==f[g]&&(this.hasRemoteDependency(!0),
this.dependencies[h]=f[g],f[g].registerDependant(c+"!"+this.getAddress(),this));break;case "remoteCell":for(d=0;d<l.length;d++)f=l[d].split("!"),m=r.trim(f[0]),h=r.trim(f[1]),f=this.sheet.getRemoteCell(m,h),q=r(m).attr("data-calx-identifier"),"undefined"!=typeof q&&"undefined"!=typeof s.sheetRegistry[q]&&(s.sheetRegistry[q].registerDependant(this.sheet),this.sheet.registerDependency(s.sheetRegistry[q])),h=m+"!"+h,"undefined"==typeof this.dependencies[h]&&!1!==f&&(this.hasRemoteDependency(!0),this.dependencies[h]=
...
"undefined"!=typeof y&&""!==a&&!1!==a&&null!==a&&-1==m.ERROR.indexOf(a)&&r.isNumeric(a)?y(a).format(this.format):a};v.fx.setValue=function(a,b){this.format&&"undefined"!=typeof y&&""!==r.trim(a)?(this.value=y().unformat(a+""),-1<this.format.indexOf("%")&&-1==(a+"").indexOf("%")&&(this.value/=100)):this.value=r.isNumeric(a)?parseFloat(a):a;-1==this.sheet.affectedCell.indexOf(this.address)&&this.sheet.affectedCell.push(this.address);return this};v.fx.getValue=function(){return this.formula?this.computedValue:
...
"function"==typeof this.config.onAfterRender&&this.config.onAfterRender.call(this);return this};t.fx.registerCell=function(a){this.cells[a.getAddress()]=a;-1==this.affectedCell.indexOf(a.getAddress())&&this.affectedCell.push(a.getAddress())};t.fx.getCell=function(a){a=a.toUpperCase();return"undefined"!=typeof this.cells[a]?this.cells[a]:!1};t.fx.getCellRange=function(a,b){a=a.toUpperCase();b=b.toUpperCase();var c=q.cellRange(a,b),d=c.length,e={},g;for(g=0;g<d;g++)e[c[g]]=this.getCell(c[g]);return e};
...
for(var a in this.cells)this.cells[a].resyncValue();this.calculate()};t.fx.setActiveCell=function(a){this.activeCell=a};t.fx.getActiveCell=function(){return this.activeCell};t.fx.attachEvent=function(){var a=this;this.el.on("calx.getValue","input[data-cell]",function(){var b=r(this).attr("data-cell"),b=a.cells[b],c=b.getValue(),d=b.getFormat();d&&-1<d.indexOf("%")&&(c=100*c+" %");b.isCheckbox||b.el.val(c)});this.el.on("calx.renderComputedValue","input[data-cell]",function(){var b=r(this).attr("data-cell");
a.cells[b].renderComputedValue()});this.el.on("calx.setValue","input[data-cell], select[data-cell]",function(){var b=r(this).attr("data-cell"),b=a.cells[b];if(b.isCheckbox&&"checkbox"==b.el.attr("type"))if(b.el.prop("checked"))b.setValue(b.el.val());else{var c=b.el.attr("data-unchecked");b.setValue("undefined"==typeof c?"":c)}else b.isCheckbox&&"radio"==b.el.attr("type")?(b.setValue(b.el.val()),a.el.find("[name="+b.el.attr("name")+"]").not(b.el).each(function(){var b=r(this),c=b.attr("data-unchecked"),
b=b.attr("data-cell");a.cells[b].setValue("undefined"==typeof c?"":c)})):b.setValue(b.el.val())});this.el.on("calx.calculateSheet","input[data-cell]",function(){a.calculate()});this.el.on("calx.calculateCellDependant","input[data-cell], select[data-cell]",function(){var b=r(this).attr("data-cell"),b=a.cells[b];!0===s.isCalculating&&(s.isCalculating=!1);a.clearProcessedFlag();b.calculate(!0,!1);a.hasRelatedSheet()?a.calculate():a.renderComputedValue()});this.el.on(a.config.autoCalculateTrigger,"input[data-cell]",
function(){var b=r(this);b.attr("data-formula")||a.config.autoCalculate&&setTimeout(function(){b.trigger("calx.calculateCellDependant")},50)});this.el.on("blur","input[data-cell]",function(){r(this).trigger("calx.renderComputedValue")});this.el.on("change","select[data-cell], input[data-cell][type=checkbox], input[data-cell][type=radio]",function(){r(this).trigger("calx.setValue");a.config.autoCalculate&&r(this).trigger("calx.calculateCellDependant")});this.el.on("focus","input[data-cell]",function(){r(this).trigger("calx.getValue")});
