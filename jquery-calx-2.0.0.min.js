...
2*a;m.length-=a;g.length-=a}function c(){var a;a=d.lexer.lex()||1;"number"!==typeof a&&(a=d.symbols_[a]||a);return a}var d=this,e=[0],m=[null],g=[],h=this.table,l="",p=0,q=0,r=0,s=g.slice.call(arguments,1);this.lexer.setInput(a);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;this.yy.parser=this;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});var v=this.lexer.yylloc;g.push(v);var y=this.lexer.options&&this.lexer.options.ranges;this.parseError="function"===typeof this.yy.parseError?this.yy.parseError:
Object.getPrototypeOf(this).parseError;for(var w,B,z,x,C={},E,A;;){z=e[e.length-1];if(this.defaultActions[z])x=this.defaultActions[z];else{if(null===w||"undefined"==typeof w)w=c();x=h[z]&&h[z][w]}if("undefined"===typeof x||!x.length||!x[0]){A=function(a){for(var b=e.length-1,c=0;;){if((2).toString()in h[a])return c;if(0===a||2>b)return!1;b-=2;a=e[b];++c}};var D;x="";if(r)1!==B&&(D=A(z));else{D=A(z);A=[];for(E in h[z])this.terminals_[E]&&2<E&&A.push("'"+this.terminals_[E]+"'");x=this.lexer.showPosition?
"Parse error on line "+(p+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+A.join(", ")+", got '"+(this.terminals_[w]||w)+"'":"Parse error on line "+(p+1)+": Unexpected "+(1==w?"end of input":"'"+(this.terminals_[w]||w)+"'");this.parseError(x,{text:this.lexer.match,token:this.terminals_[w]||w,line:this.lexer.yylineno,loc:v,expected:A,recoverable:!1!==D})}if(3==r){if(1===w||1===B)throw Error(x||"Parsing halted while starting to recover from another error.");q=this.lexer.yyleng;l=this.lexer.yytext;
p=this.lexer.yylineno;v=this.lexer.yylloc;w=c()}if(!1===D)throw Error(x||"Parsing halted. No suitable error recovery rule available.");b(D);B=2==w?null:w;w=2;z=e[e.length-1];x=h[z]&&h[z][2];r=3}if(x[0]instanceof Array&&1<x.length)throw Error("Parse Error: multiple actions possible at state: "+z+", token: "+w);switch(x[0]){case 1:e.push(w);m.push(this.lexer.yytext);g.push(this.lexer.yylloc);e.push(x[1]);w=null;B?(w=B,B=null):(q=this.lexer.yyleng,l=this.lexer.yytext,p=this.lexer.yylineno,v=this.lexer.yylloc,
0<r&&r--);break;case 2:A=this.productions_[x[1]][1];C.$=m[m.length-A];C._$={first_line:g[g.length-(A||1)].first_line,last_line:g[g.length-1].last_line,first_column:g[g.length-(A||1)].first_column,last_column:g[g.length-1].last_column};y&&(C._$.range=[g[g.length-(A||1)].range[0],g[g.length-1].range[1]]);z=this.performAction.apply(C,[l,q,p,this.yy,x[1],m,g].concat(s));if("undefined"!==typeof z)return z;A&&(e=e.slice(0,-2*A),m=m.slice(0,-1*A),g=g.slice(0,-1*A));e.push(this.productions_[x[1]][0]);m.push(C.$);
g.push(C._$);z=h[e[e.length-2]][e[e.length-1]];e.push(z);break;case 3:return!0}}}},d=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a){this._input=a;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=this.matched=this.match="";this.conditionStack=["INITIAL"];this.yylloc={first_line:1,first_column:0,last_line:1,last_column:0};this.options.ranges&&(this.yylloc.range=[0,0]);this.offset=
...
if(!d.isValid()||!f.isValid())return"#VALUE!";if(-1===[0,1,2,3,4].indexOf(c))return"#NUM!";if(d===f)return 0;0<d.diff(f)&&(f=h(new Date(a)),d=h(new Date(b)));var k=d.year(),e=d.month(),n=d.date(),t=f.year();a=f.month();b=f.date();switch(c){case 0:return 31===n&&31===b?b=n=30:31===n?n=30:30===n&&31===b?b=30:1===e&&1===a&&d.daysInMonth()===n&&f.daysInMonth()===b?b=n=30:1===e&&d.daysInMonth()===n&&(n=30),(b+30*a+360*t-(n+30*e+360*k))/360;case 1:c=365;if(k===t||k+1===t&&(e>a||e===a&&n>=b)){if(k===t&&
h([k]).isLeapYear())c=366;else if(k=d,t=f,e=h(new Date(k.year(),2,1)),h([k.year()]).isLeapYear()&&0>k.diff(e)&&0<=t.diff(e)?k=!0:(e=h(new Date(t.year(),2,1)),k=h([t.year()]).isLeapYear()&&0<=t.diff(e)&&0>k.diff(e)?!0:!1),k||1===a&&29===b)c=366;return f.diff(d,"days")/c}a=t-k+1;a=h(new Date(t+1,0,1)).diff(h(new Date(k,0,1)),"days")/a;return f.diff(d,"days")/a;case 2:return f.diff(d,"days")/360;case 3:return f.diff(d,"days")/365;case 4:return 31===n&&(n=30),31===b&&(b=30),(b+30*a+360*t-(n+30*e+360*
...
10),f+=c;return 0===f&&""===q.trim(d)?"":f},SUMIF:function(a,b){for(var c=0,d=0;d<a.length;d++)c+=eval(a[d]+b)?a[d]:0;return c},SUMIFS:function(){for(var a=(arguments.length-1)/2,b=arguments[0],c=0,d=0;d<b.length;d++){for(var f=!0,k=0;k<a;k++)eval(arguments[2*k+1][d]+arguments[2*k+2])||(f=!1);c+=f?b[d]:0}return c},SUMPRODUCT:function(){for(var a=arguments.length+1,b=0,c=0;c<arguments[0].length;c++)for(var d=0;d<arguments[0][c].length;d++){for(var f=1,k=1;k<a;k++)f*=arguments[k-1][c][d];b+=f}return b},
...
b)):"#VALUE!"},VDB:function(){},XIRR:function(a,b,c){var d=[],f;for(f in a)d.push(a[f]);a=function(a,b,c){c+=1;for(var d=a[0],f=1;f<a.length;f++)d+=a[f]/Math.pow(c,h(b[f]).diff(h(b[0]),"days")/365);return d};f=function(a,b,c){c+=1;for(var d=0,f=1;f<a.length;f++)var k=h(b[f]).diff(h(b[0]),"days")/365,d=d-k*a[f]/Math.pow(c,k+1);return d};for(var k=!1,e=!1,n=0;n<d.length;n++)0<d[n]&&(k=!0),0>d[n]&&(e=!0);if(!k||!e)return"#NUM!";c=c||.1;var g,k=0,e=!0;do g=a(d,b,c),e=c-g/f(d,b,c),n=Math.abs(e-c),c=e,
e=1E-10<n&&1E-10<Math.abs(g);while(e&&50>++k);return e?"#NUM!":c},XNPV:function(a,b,c){for(var d=0,f=0;f<b.length;f++)d+=b[f]/Math.pow(1+a,h(c[f]).diff(h(c[0]),"days")/365);return d},YIELD:function(){},YIELDDISC:function(){},YIELDMAT:function(){}},statistic:{AVEDEV:function(){if("undefined"==typeof g)return l.ERRKEY.jStatRequired;var a=p.arrayMerge(arguments);return g.sum(g(a).subtract(g.mean(a)).abs()[0])/a.length},AVERAGE:function(){for(var a=p.arrayMerge(arguments),b=a.length,c=0,d=0,f=0,k=0;k<
...
e.statistic.COUNTBLANK(a)},COUNTBLANK:function(){for(var a=p.arrayMerge(arguments),b=0,c=0;c<a.length;c++)null!==a[c]&&""!==a[c]||b++;return b},COUNTIF:function(a,b){for(var c=0,d=0;d<a.length;d++)a[d].match(new RegExp(b))&&c++;return c},COUNTIFS:function(){for(var a=(arguments.length-1)/2,b=arguments[0],c=0,d=0;d<b.length;d++){for(var f=!0,k=0;k<a;k++)eval(arguments[2*k+1][d]+arguments[2*k+2])||(f=!1);c+=f?1:0}return c},COUNTUNIQUE:function(){return p.unique(p.arrayMerge(arguments)).length},COVARIANCEP:function(a,
...
0,n=0,g=0,m=0;for(f=0;f<k;f++)var h=b[f],l=Math.log(a[f]),e=e+h,n=n+l,g=g+h*l,m=m+h*h;e/=k;n/=k;g/=k;m/=k;d?(a=(g-e*n)/(m-e*e),e=n-a*e):(a=g/m,e=0);n=[];for(f=0;f<c.length;f++)n.push(Math.exp(e+a*c[f]));return n},HARMEAN:function(){for(var a=p.arrayMerge(arguments),b=a.length,c=0,d=0;d<b;d++)c+=1/a[d];return b/c},HYPGEOMDIST:function(a,b,c,d,f){function k(a,b,c,d){return e.math.COMBIN(c,a)*e.math.COMBIN(d-c,b-a)/e.math.COMBIN(d,b)}function g(a,b,c,d){for(var f=0,e=0;e<=a;e++)f+=k(e,b,c,d);return f}
...
c;f++)d+=Math.pow(a[f]-b,3);return c*d/((c-1)*(c-2)*Math.pow(g.stdev(a,!0),3))},SKEWP:function(){if("undefined"==typeof g)return l.ERRKEY.jStatRequired;for(var a=p.arrayMerge(arguments),b=g.mean(a),c=a.length,d=0,f=0,e=0;e<c;e++)f+=Math.pow(a[e]-b,3),d+=Math.pow(a[e]-b,2);return f/c/Math.pow(d/c,1.5)},SLOPE:function(a,b){if("undefined"==typeof g)return l.ERRKEY.jStatRequired;for(var c=g.mean(b),d=g.mean(a),f=b.length,e=0,h=0,n=0;n<f;n++)e+=(b[n]-c)*(a[n]-d),h+=Math.pow(b[n]-c,2);return e/h},SMALL:function(a,
b){return a.sort(function(a,b){return a-b})[b-1]},STANDARDIZE:function(a,b,c){return(a-b)/c},STDEVA:function(){for(var a=p.arrayMerge(arguments),b=a.length,c=0,d=g.mean(a),f=0;f<b;f++)c+=Math.pow(a[f]-d,2);return Math.sqrt(c/(b-1))},STDEVP:function(){for(var a=p.arrayMerge(arguments),b=a.length,c=0,d=0,f=e.statistic.AVERAGE(a),k=0;k<b;k++)!0!==a[k]&&!1!==a[k]&&(c+=Math.pow(a[k]-f,2),d++);return Math.sqrt(c/d)},STDEVPA:function(){if("undefined"==typeof g)return l.ERRKEY.jStatRequired;for(var a=p.arrayMerge(arguments),
b=a.length,c=0,d=g.mean(a),f=0;f<b;f++)c+=Math.pow(a[f]-d,2);return Math.sqrt(c/b)},STDEVS:function(){for(var a=p.arrayMerge(arguments),b=a.length,c=0,d=0,f=e.statistic.AVERAGE(a),k=0;k<b;k++)!0!==a[k]&&!1!==a[k]&&(c+=Math.pow(a[k]-f,2),d++);return Math.sqrt(c/(d-1))},STEYX:function(a,b){if("undefined"==typeof g)return l.ERRKEY.jStatRequired;for(var c=g.mean(b),d=g.mean(a),f=b.length,e=0,h=0,n=0,t=0;t<f;t++)e+=Math.pow(a[t]-d,2),h+=(b[t]-c)*(a[t]-d),n+=Math.pow(b[t]-c,2);return Math.sqrt((e-h*h/n)/
...
c=b?0<=b.indexOf("0")?y(a).format(b):h(new Date(a)).format(b):a:a.toString&&"function"===typeof a.toString&&(c=a.toString());return c},TRIM:function(a){return q.trim(a)},UNICHAR:function(a){return e.text.CHAR(a)},UNICODE:function(a){return e.text.CODE(a)},UPPER:function(a){return a.toUpperCase()},VALUE:function(a){return"undefined"==typeof y?"#NAME?":y().unformat(a)}},trigonometry:{},general:{VLOOKUP:function(a,b,c,d){var f,e;typeof("object"==b)&&"Object"==b.constructor.name&&(b=p.rangeToTable(b));
...
p.rangeToTable(a);f.series={bars:{show:!0,barWidth:.6,align:"center"},stack:!0};"undefined"!=typeof c.bar_orientation&&"horizontal"==c.bar_orientation&&(f.series.bars.horizontal=!0);break;case "pie":g=p.objectToArray(a);f.series={pie:{show:!0,radius:.8}};f.legend={show:!1};break;case "doughnut":case "donut":g=p.objectToArray(a);f.series={pie:{show:!0,innerRadius:.5,radius:.8}};f.legend={show:!1};break;default:g=p.rangeToTable(a)}"undefined"!=typeof c.orientation&&"vertical"==c.orientation&&(g=p.transposeTable(g));
if("undefined"!=typeof c.label){e=this.evaluate(c.label);e=p.objectToArray(e);var h=g.length,l,m,r;for(m=0;m<h;m++)for(l=g[m].length,r=0;r<l;r++)a=g[m][r],g[m][r]=[e[r],a];f.xaxis={mode:"categories",tickLength:0}}else for(h=g.length,m=0;m<h;m++)for(l=g[m].length,r=0;r<l;r++)a=g[m][r],g[m][r]="undefined"!=typeof c.bar_orientation&&"horizontal"==c.bar_orientation?[a,r]:[r,a];if("undefined"!=typeof c.legend){c=this.evaluate(c.legend);c=p.objectToArray(c);e=[];for(h=0;h<g.length;h++)e.push({label:c[h],
data:g[h]});g=e}f.grid={backgroundColor:{colors:["#fff","#eee"]},borderWidth:{top:0,right:0,bottom:0,left:0}};console.log(f);console.log(g);setTimeout(function(){q.plot(d,g,f)},100);return!1}},engineering:{BIN2DEC:function(a){if(!p.isValidBinary(a))return"#NUM!";var b=parseInt(a,2);a=a.toString();return 10===a.length&&"1"===a.substring(0,1)?parseInt(a.substring(1),2)-512:b},BIN2HEX:function(a,b){if(!p.isValidBinary(a))return"#NUM!";var c=a.toString();if(10===c.length&&"1"===c.substring(0,1))return(0xfffffffe00+
parseInt(c.substring(1),2)).toString(16);c=parseInt(a,2).toString(16);if("undefined"===typeof b)return c;if(isNaN(b))return"#VALUE!";if(0>b)return"#NUM!";b=Math.floor(b);return b>=c.length?p.repeat("0",b-c.length)+c:"#NUM!"},BIN2OCT:function(a,b){if(!p.isValidBinary(a))return"#NUM!";var c=a.toString();if(10===c.length&&"1"===c.substring(0,1))return(1073741312+parseInt(c.substring(1),2)).toString(8);c=parseInt(a,2).toString(8);if("undefined"===typeof b)return c;if(isNaN(b))return"#VALUE!";if(0>b)return"#NUM!";
b=Math.floor(b);return b>=c.length?p.repeat("0",b-c.length)+c:"#NUM!"},BITAND:function(a,b){a=parseFloat(a,10);b=parseFloat(b,10);return isNaN(a)||isNaN(b)?"#VALUE!":0>a||0>b||Math.floor(a)!==a||Math.floor(b)!==b||0xffffffffffff<a||0xffffffffffff<b?"#NUM!":a&b},BITLSHIFT:function(a,b){a=parseFloat(a,10);b=parseFloat(b,10);return isNaN(a)||isNaN(b)?"#VALUE!":0>a||Math.floor(a)!==a||0xffffffffffff<a||53<Math.abs(b)?"#NUM!":0<=b?a<<b:a>>-b},BITOR:function(a,b){a=parseFloat(a,10);b=parseFloat(b,10);return isNaN(a)||
...
e:["dekao",10,"e"],d:["deci",.1,"d"],c:["centi",.01,"c"],m:["milli",.001,"m"],u:["micro",1E-6,"u"],n:["nano",1E-9,"n"],p:["pico",1E-12,"p"],f:["femto",1E-15,"f"],a:["atto",1E-18,"a"],z:["zepto",1E-21,"z"],y:["yocto",1E-24,"y"]},g=null,h=null,l=b,m=c,p=1,r=1,q,s=0;s<d.length;s++){q=null===d[s][2]?[]:d[s][2];if(d[s][1]===l||0<=q.indexOf(l))g=d[s];if(d[s][1]===m||0<=q.indexOf(m))h=d[s]}if(null===g)for(q=f[b.substring(0,2)],s=e[b.substring(0,1)],"da"===b.substring(0,2)&&(s=["dekao",10,"da"]),q?(p=q[2],
l=b.substring(2)):s&&(p=s[1],l=b.substring(s[2].length)),b=0;b<d.length;b++)if(q=null===d[b][2]?[]:d[b][2],d[b][1]===l||0<=q.indexOf(l))g=d[b];if(null===h)for(f=f[c.substring(0,2)],e=e[c.substring(0,1)],"da"===c.substring(0,2)&&(e=["dekao",10,"da"]),f?(r=f[2],m=c.substring(2)):e&&(r=e[1],m=c.substring(e[2].length)),c=0;c<d.length;c++)if(q=null===d[c][2]?[]:d[c][2],d[c][1]===m||0<=q.indexOf(m))h=d[c];return null===g||null===h||g[3]!==h[3]?"#N/A":a*g[6]*p/(h[6]*r)},DEC2BIN:function(a,b){if(isNaN(a))return"#VALUE!";
if(!/^-?[0-9]{1,3}$/.test(a)||-512>a||511<a)return"#NUM!";if(0>a)return"1"+p.repeat("0",9-(512+a).toString(2).length)+(512+a).toString(2);var c=parseInt(a,10).toString(2);if("undefined"===typeof b)return c;if(isNaN(b))return"#VALUE!";if(0>b)return"#NUM!";b=Math.floor(b);return b>=c.length?p.repeat("0",b-c.length)+c:"#NUM!"},DEC2HEX:function(a,b){if(isNaN(a))return"#VALUE!";if(!/^-?[0-9]{1,12}$/.test(a)||-549755813888>a||549755813887<a)return"#NUM!";if(0>a)return(1099511627776+a).toString(16);var c=
...
"f"===a.substring(0,1).toLowerCase()?!0:!1,d=c?parseInt(a,16)-1099511627776:parseInt(a,16);if(-512>d||511<d)return"#NUM!";if(c)return"1"+p.repeat("0",9-(512+d).toString(2).length)+(512+d).toString(2);c=d.toString(2);if("undefined"===typeof b)return c;if(isNaN(b))return"#VALUE!";if(0>b)return"#NUM!";b=Math.floor(b);return b>=c.length?p.repeat("0",b-c.length)+c:"#NUM!"},HEX2DEC:function(a){if(!/^[0-9A-Fa-f]{1,10}$/.test(a))return"#NUM!";a=parseInt(a,16);return 549755813888<=a?a-1099511627776:a},HEX2OCT:function(a,
...
b=Math.sqrt(e.engineering.IMABS(a));a=e.engineering.IMARGUMENT(a);return e.engineering.COMPLEX(b*Math.cos(a/2),b*Math.sin(a/2),d)},IMSUB:function(a,b){var c=e.engineering.IMREAL(a),d=e.engineering.IMAGINARY(a),f=e.engineering.IMREAL(b),k=e.engineering.IMAGINARY(b),g=a.substring(a.length-1),h=a.substring(a.length-1),l="i";"j"===g?l="j":"j"===h&&(l="j");return"#NUM!"===c||"#NUM!"===d||"#NUM!"===f||"#NUM!"===k?"#NUM!":e.engineering.COMPLEX(c-f,d-k,l)},IMSUM:function(){for(var a=arguments[0],b=1;b<arguments.length;b++){var c=
...
this.sheet.config.onAfterRender.call(this.sheet);return this};v.fx.buildDependency=function(){var a={remoteCellRange:/\#[A-Za-z0-9_]+\s*!\s*[A-Za-z]+[0-9]+\s*:\s*[A-Za-z]+[0-9]+/g,remoteCell:/\#[A-Za-z0-9_]+\s*!\s*[A-Za-z]+[0-9]+/g,cellRange:/[A-Za-z]+[0-9]+\s*:\s*[A-Za-z]+[0-9]+/g,cell:/[A-Z]+[0-9]+/g},b=this.formula,c="#"+this.sheet.el.attr("id"),d=this.address,f,e,g,h,l,m,p;for(e in this.dependencies)-1===e.indexOf("#")?this.dependencies[e].removeDependant(d):this.dependencies[e].removeDependant(c+
"!"+d),delete this.dependencies[e];if(b)for(e in a)if(l=b.match(a[e]),b=b.replace(a[e],""),null!==l)switch(e){case "remoteCellRange":for(d=0;d<l.length;d++)for(g in f=l[d].split("!"),m=q.trim(f[0]),h=f[1].split(":"),f=q.trim(h[0]),h=q.trim(h[1]),f=this.sheet.getRemoteCellRange(m,f,h),p=q(m).attr("data-calx-identifier"),"undefined"!=typeof p&&"undefined"!=typeof r.sheetRegistry[p]&&(r.sheetRegistry[p].registerDependant(this.sheet),this.sheet.registerDependency(r.sheetRegistry[p])),f)h=m+"!"+g,"undefined"==
typeof this.dependencies[h]&&!1!==f[g]&&(this.hasRemoteDependency(!0),this.dependencies[h]=f[g],f[g].registerDependant(c+"!"+this.getAddress(),this));break;case "remoteCell":for(d=0;d<l.length;d++)f=l[d].split("!"),m=q.trim(f[0]),h=q.trim(f[1]),f=this.sheet.getRemoteCell(m,h),p=q(m).attr("data-calx-identifier"),"undefined"!=typeof p&&"undefined"!=typeof r.sheetRegistry[p]&&(r.sheetRegistry[p].registerDependant(this.sheet),this.sheet.registerDependency(r.sheetRegistry[p])),h=m+"!"+h,"undefined"==typeof this.dependencies[h]&&
!1!==f&&(this.hasRemoteDependency(!0),this.dependencies[h]=f,f.registerDependant(c+"!"+this.getAddress(),this));break;case "cellRange":for(d=0;d<l.length;d++)for(g in h=l[d].split(":"),f=q.trim(h[0]),h=q.trim(h[1]),f=this.sheet.getCellRange(f,h),f)"undefined"==typeof this.dependencies[g]&&!1!==f[g]&&(this.dependencies[g]=f[g],f[g].registerDependant(this.getAddress(),this));break;case "cell":for(d=0;d<l.length;d++)h=l[d],f=this.sheet.getCell(h),"undefined"==typeof this.dependencies[h]&&!1!==f&&(this.dependencies[h]=
f,f.registerDependant(this.getAddress(),this))}return this};v.fx.removeDependency=function(a){"undefined"!=typeof this.dependencies[a]&&delete this.dependencies[a]};v.fx.processDependency=function(){if(0==this.isProcessed()){for(var a in this.dependencies)0==this.dependencies[a].isProcessed()&&this.dependencies[a].processDependency();this.evaluateFormula();this.setProcessed(!0);-1==this.sheet.affectedCell.indexOf(this.address)&&this.sheet.affectedCell.push(this.address)}};v.fx.registerDependant=function(a,
