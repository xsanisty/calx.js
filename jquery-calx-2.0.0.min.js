...
this.config.onAfterCalculate.call(this);"function"==typeof this.config.onBeforeRender&&this.config.onBeforeRender.call(this);this.renderComputedValue();"function"==typeof this.config.onAfterRender&&this.config.onAfterRender.call(this);return this};t.fx.registerCell=function(a){this.cells[a.getAddress()]=a;-1==this.affectedCell.indexOf(a.getAddress())&&this.affectedCell.push(a.getAddress())};t.fx.registerVariable=function(a,b){if("object"==typeof a)for(var c in a)this.variables[c]=a[c];else this.variables[a]=
b};t.fx.getCell=function(a){a=a.toUpperCase();return"undefined"!=typeof this.cells[a]?this.cells[a]:!1};t.fx.getCellRange=function(a,b){a=a.toUpperCase();b=b.toUpperCase();var c=q.cellRange(a,b),d=c.length,e={},g;for(g=0;g<d;g++)e[c[g]]=this.getCell(c[g]);return e};t.fx.applyChange=function(){for(var a in this.cells)this.cells[a].processDependency(!1,!1);for(a in this.cells)this.cells[a].renderComputedValue();return this};t.fx.scan=function(){};t.fx.refresh=function(){var a=this.el.find("[data-cell],[data-formula],[data-format]"),
...
typeof c?0:c)for(var d in e)"undefined"!=typeof e[d][a]&&delete e[d][a];e.user_defined[a]=b},registerVariable:function(a,b,c){if("undefined"==typeof c?0:c)if("object"==typeof a)for(var d in a)m.VARIABLE[d]=a[d];else m.VARIABLE[a]=b;else this.each(function(){var c=r(this).attr("data-calx-identifier");c&&"undefined"!=typeof s.sheetRegistry[c]&&s.sheetRegistry[c].registerVariable(a,b)});return this},refresh:function(){return this.each(function(){var a=r(this).attr("data-calx-identifier");a&&"undefined"==
