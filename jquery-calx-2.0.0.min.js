...
this.setCalculated();for(a in this.cells)this.cells[a].hasRemoteDependency()&&this.cells[a].evaluateFormula();this.calculateDependant(this.identifier);"function"==typeof this.config.onAfterCalculate&&this.config.onAfterCalculate.call(this);"function"==typeof this.config.onBeforeRender&&this.config.onBeforeRender.call(this);this.renderComputedValue();"function"==typeof this.config.onAfterRender&&this.config.onAfterRender.call(this);return this};t.fx.calculateDependant=function(a){};t.fx.calculateDependency=
function(a){};t.fx.registerCell=function(a){this.cells[a.getAddress()]=a;-1==this.affectedCell.indexOf(a.getAddress())&&this.affectedCell.push(a.getAddress())};t.fx.registerVariable=function(a,b){if("object"==typeof a)for(var c in a)this.variables[c]=a[c];else this.variables[a]=b};t.fx.getCell=function(a){a=a.toUpperCase();return"undefined"!=typeof this.cells[a]?this.cells[a]:!1};t.fx.getCellRange=function(a,b){a=a.toUpperCase();b=b.toUpperCase();var c=q.cellRange(a,b),d=c.length,e={},g;for(g=0;g<
d;g++)e[c[g]]=this.getCell(c[g]);return e};t.fx.applyChange=function(){for(var a in this.cells)this.cells[a].processDependency(!1,!1);for(a in this.cells)this.cells[a].renderComputedValue();return this};t.fx.scan=function(){};t.fx.refresh=function(){var a=this.el.find("[data-cell],[data-formula],[data-format]"),b=this,c;this.totalCell=a.length;this.cells={};a.each(function(){c=new v(b,this);b.registerCell(c)});this.buildCellDependency()};t.fx.reset=function(){("form"==this.el.prop("tagName").toLowerCase()?
...
"input[data-cell]",function(){var b=r(this).attr("data-cell");a.cells[b].renderComputedValue()});this.el.on("calx.setValue","input[data-cell], select[data-cell]",function(){var b=r(this).attr("data-cell"),b=a.cells[b],c=b.getValue(),d=b.el.val();if(b.isCheckbox&&"checkbox"==b.el.attr("type"))if(b.el.prop("checked"))b.setValue(d);else{var e=b.el.attr("data-unchecked");b.setValue("undefined"==typeof e?"":e)}else b.isCheckbox&&"radio"==b.el.attr("type")?(b.setValue(d),a.el.find("[name="+b.el.attr("name")+
