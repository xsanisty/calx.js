...
[2,3],[2,4]],performAction:function(b,c,d,n,l,p,g){b=p.length-1;switch(l){case 1:return p[b-1];case 2:this.$=a.getVariable(p[b]);break;case 3:this.$=a.time(p[b]);break;case 4:this.$=a.time(p[b]);break;case 5:this.$=1*p[b];isNaN(this.$)&&(this.$=0);break;case 6:this.$=p[b].substring(1,p[b].length-1);break;case 7:this.$=a.comparator.equal.call(a,p[b-2],p[b]);break;case 8:this.$=e.math.SUM.call(a,p[b-2],p[b]);break;case 9:this.$=1*p[b-1];break;case 10:this.$=p[b-1];break;case 11:this.$=a.comparator.lessEqual.call(a,
p[b-3],p[b]);break;case 12:this.$=a.comparator.greaterEqual.call(a,p[b-3],p[b]);break;case 13:this.$=a.comparator.notEqual.call(a,p[b-3],p[b]);break;case 14:this.$=p[b-2]!=p[b];break;case 15:this.$=a.comparator.greater.call(a,p[b-2],p[b]);break;case 16:this.$=a.comparator.less.call(a,p[b-2],p[b]);break;case 17:this.$=e.math.SUBTRACT.call(a,p[b-2],p[b]);break;case 18:this.$=e.math.MULTIPLY.call(a,p[b-2],p[b]);break;case 19:this.$=e.math.DIVIDE.call(a,p[b-2],p[b]);break;case 20:this.$=e.math.POWER.call(a,
p[b-2],p[b]);break;case 21:this.$=-1*p[b];isNaN(this.$)&&(this.$=0);break;case 22:this.$=1*p[b];isNaN(this.$)&&(this.$=0);break;case 23:this.$=Math.E;break;case 24:this.$=a.callFunction(p[b-2]);break;case 25:this.$=a.callFunction(p[b-3],p[b-1]);break;case 29:this.$=a.getCellValue(p[b]);break;case 30:this.$=a.getCellRangeValue(p[b-2],p[b]);break;case 31:this.$=a.getCellValue(p[b]);break;case 32:this.$=a.getCellRangeValue(p[b-2],p[b]);break;case 33:this.$=a.getRemoteCellValue(p[b-2],p[b]);break;case 34:this.$=
a.getRemoteCellRangeValue(p[b-4],p[b-2],p[b]);break;case 35:this.$=[p[b]];break;case 36:p[b-2].push(p[b]);this.$=p[b-2];break;case 37:p[b-2].push(p[b]);this.$=p[b-2];break;case 38:this.$=[p[b]];break;case 39:this.$=r.isArray(p[b-2])?p[b-2]:[p[b-2]];this.$.push(p[b]);break;case 40:this.$=1*p[b];break;case 41:this.$=1*(p[b-2]+"."+p[b]);break;case 42:this.$=.01*p[b-1];break;case 43:this.$=p[b-2]+p[b-1]+p[b];break;case 44:this.$=p[b-2]+p[b-1]+p[b]}},table:[{2:15,3:1,4:2,6:3,7:[1,4],8:[1,5],9:6,10:[1,
...
2*a;p.length-=a;g.length-=a}function c(){var a;a=d.lexer.lex()||1;"number"!==typeof a&&(a=d.symbols_[a]||a);return a}var d=this,e=[0],p=[null],g=[],h=this.table,m="",q=0,r=0,s=0,t=g.slice.call(arguments,1);this.lexer.setInput(a);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;this.yy.parser=this;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});var v=this.lexer.yylloc;g.push(v);var y=this.lexer.options&&this.lexer.options.ranges;this.parseError="function"===typeof this.yy.parseError?this.yy.parseError:
Object.getPrototypeOf(this).parseError;for(var w,B,z,x,C={},E,A;;){z=e[e.length-1];if(this.defaultActions[z])x=this.defaultActions[z];else{if(null===w||"undefined"==typeof w)w=c();x=h[z]&&h[z][w]}if("undefined"===typeof x||!x.length||!x[0]){A=function(a){for(var b=e.length-1,c=0;;){if((2).toString()in h[a])return c;if(0===a||2>b)return!1;b-=2;a=e[b];++c}};var D;x="";if(s)1!==B&&(D=A(z));else{D=A(z);A=[];for(E in h[z])this.terminals_[E]&&2<E&&A.push("'"+this.terminals_[E]+"'");x=this.lexer.showPosition?
"Parse error on line "+(q+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+A.join(", ")+", got '"+(this.terminals_[w]||w)+"'":"Parse error on line "+(q+1)+": Unexpected "+(1==w?"end of input":"'"+(this.terminals_[w]||w)+"'");this.parseError(x,{text:this.lexer.match,token:this.terminals_[w]||w,line:this.lexer.yylineno,loc:v,expected:A,recoverable:!1!==D})}if(3==s){if(1===w||1===B)throw Error(x||"Parsing halted while starting to recover from another error.");r=this.lexer.yyleng;m=this.lexer.yytext;
q=this.lexer.yylineno;v=this.lexer.yylloc;w=c()}if(!1===D)throw Error(x||"Parsing halted. No suitable error recovery rule available.");b(D);B=2==w?null:w;w=2;z=e[e.length-1];x=h[z]&&h[z][2];s=3}if(x[0]instanceof Array&&1<x.length)throw Error("Parse Error: multiple actions possible at state: "+z+", token: "+w);switch(x[0]){case 1:e.push(w);p.push(this.lexer.yytext);g.push(this.lexer.yylloc);e.push(x[1]);w=null;B?(w=B,B=null):(r=this.lexer.yyleng,m=this.lexer.yytext,q=this.lexer.yylineno,v=this.lexer.yylloc,
0<s&&s--);break;case 2:A=this.productions_[x[1]][1];C.$=p[p.length-A];C._$={first_line:g[g.length-(A||1)].first_line,last_line:g[g.length-1].last_line,first_column:g[g.length-(A||1)].first_column,last_column:g[g.length-1].last_column};y&&(C._$.range=[g[g.length-(A||1)].range[0],g[g.length-1].range[1]]);z=this.performAction.apply(C,[m,r,q,this.yy,x[1],p,g].concat(t));if("undefined"!==typeof z)return z;A&&(e=e.slice(0,-2*A),p=p.slice(0,-1*A),g=g.slice(0,-1*A));e.push(this.productions_[x[1]][0]);p.push(C.$);
...
if(!d.isValid()||!f.isValid())return"#VALUE!";if(-1===[0,1,2,3,4].indexOf(c))return"#NUM!";if(d===f)return 0;0<d.diff(f)&&(f=h(new Date(a)),d=h(new Date(b)));var k=d.year(),e=d.month(),n=d.date(),l=f.year();a=f.month();b=f.date();switch(c){case 0:return 31===n&&31===b?b=n=30:31===n?n=30:30===n&&31===b?b=30:1===e&&1===a&&d.daysInMonth()===n&&f.daysInMonth()===b?b=n=30:1===e&&d.daysInMonth()===n&&(n=30),(b+30*a+360*l-(n+30*e+360*k))/360;case 1:c=365;if(k===l||k+1===l&&(e>a||e===a&&n>=b)){if(k===l&&
h([k]).isLeapYear())c=366;else if(k=d,l=f,e=h(new Date(k.year(),2,1)),h([k.year()]).isLeapYear()&&0>k.diff(e)&&0<=l.diff(e)?k=!0:(e=h(new Date(l.year(),2,1)),k=h([l.year()]).isLeapYear()&&0<=l.diff(e)&&0>k.diff(e)?!0:!1),k||1===a&&29===b)c=366;return f.diff(d,"days")/c}a=l-k+1;a=h(new Date(l+1,0,1)).diff(h(new Date(k,0,1)),"days")/a;return f.diff(d,"days")/a;case 2:return f.diff(d,"days")/360;case 3:return f.diff(d,"days")/365;case 4:return 31===n&&(n=30),31===b&&(b=30),(b+30*a+360*l-(n+30*e+360*
...
10),f+=c;return 0===f&&""===r.trim(d)?"":f},SUMIF:function(a,b){for(var c=0,d=0;d<a.length;d++)c+=eval(a[d]+b)?a[d]:0;return c},SUMIFS:function(){for(var a=(arguments.length-1)/2,b=arguments[0],c=0,d=0;d<b.length;d++){for(var f=!0,k=0;k<a;k++)eval(arguments[2*k+1][d]+arguments[2*k+2])||(f=!1);c+=f?b[d]:0}return c},SUMPRODUCT:function(){for(var a=arguments.length+1,b=0,c=0;c<arguments[0].length;c++)for(var d=0;d<arguments[0][c].length;d++){for(var f=1,k=1;k<a;k++)f*=arguments[k-1][c][d];b+=f}return b},
...
c=b?0<=b.indexOf("0")?y(a).format(b):h(new Date(a)).format(b):a:a.toString&&"function"===typeof a.toString&&(c=a.toString());return c},TRIM:function(a){return r.trim(a)},UNICHAR:function(a){return e.text.CHAR(a)},UNICODE:function(a){return e.text.CODE(a)},UPPER:function(a){return a.toUpperCase()},VALUE:function(a){return"undefined"==typeof y?"#NAME?":y().unformat(a)}},trigonometry:{},general:{VLOOKUP:function(a,b,c,d){var f,e;typeof("object"==b)&&"Object"==b.constructor.name&&(b=q.rangeToTable(b));
...
cell:/[A-Z]+[0-9]+/g},b=this.formula,c="#"+this.sheet.el.attr("id"),d=this.address,f,e,g,h,l,m,q;for(e in this.dependencies)-1===e.indexOf("#")?this.dependencies[e].removeDependant(d):this.dependencies[e].removeDependant(c+"!"+d),delete this.dependencies[e];if(b)for(e in a)if(l=b.match(a[e]),b=b.replace(a[e],""),null!==l)switch(e){case "remoteCellRange":for(d=0;d<l.length;d++)for(g in f=l[d].split("!"),m=r.trim(f[0]),h=f[1].split(":"),f=r.trim(h[0]),h=r.trim(h[1]),f=this.sheet.getRemoteCellRange(m,
f,h),q=r(m).attr("data-calx-identifier"),"undefined"!=typeof q&&"undefined"!=typeof s.sheetRegistry[q]&&(s.sheetRegistry[q].registerDependant(this.sheet),this.sheet.registerDependency(s.sheetRegistry[q])),f)h=m+"!"+g,"undefined"==typeof this.dependencies[h]&&!1!==f[g]&&(this.hasRemoteDependency(!0),this.dependencies[h]=f[g],f[g].registerDependant(c+"!"+this.getAddress(),this));break;case "remoteCell":for(d=0;d<l.length;d++)f=l[d].split("!"),m=r.trim(f[0]),h=r.trim(f[1]),f=this.sheet.getRemoteCell(m,
h),q=r(m).attr("data-calx-identifier"),"undefined"!=typeof q&&"undefined"!=typeof s.sheetRegistry[q]&&(s.sheetRegistry[q].registerDependant(this.sheet),this.sheet.registerDependency(s.sheetRegistry[q])),h=m+"!"+h,"undefined"==typeof this.dependencies[h]&&!1!==f&&(this.hasRemoteDependency(!0),this.dependencies[h]=f,f.registerDependant(c+"!"+this.getAddress(),this));break;case "cellRange":for(d=0;d<l.length;d++)for(g in h=l[d].split(":"),f=r.trim(h[0]),h=r.trim(h[1]),f=this.sheet.getCellRange(f,h),
...
this.cells[a].setAffected(!1))};t.fx.buildCellDependency=function(){for(var a in this.cells)this.cells[a].buildDependency()};t.fx.renderComputedValue=function(){for(var a=0;a<this.affectedCell.length;a++)this.cells[this.affectedCell[a]].renderComputedValue();this.clearAffectedCell()};t.fx.clearAffectedCell=function(){this.affectedCell=[]};t.fx.hasRelatedSheet=function(){return this.relatedSheet};t.fx.clearCalculatedFlag=function(){for(var a in this.dependant)this.dependant[a].setCalculated(!1);for(a in this.dependencies)this.dependencies[a].setCalculated(!1)};
...
this.cells[a].evaluateFormula();"function"==typeof this.config.onAfterCalculate&&this.config.onAfterCalculate.call(this);"function"==typeof this.config.onBeforeRender&&this.config.onBeforeRender.call(this);this.renderComputedValue();"function"==typeof this.config.onAfterRender&&this.config.onAfterRender.call(this);return this};t.fx.registerCell=function(a){this.cells[a.getAddress()]=a;-1==this.affectedCell.indexOf(a.getAddress())&&this.affectedCell.push(a.getAddress())};t.fx.getCell=function(a){a=
