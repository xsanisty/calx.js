...
"input[data-cell], select[data-cell]",function(){var b=r(this).attr("data-cell"),b=a.cells[b],c=b.getValue(),d=b.el.val();if(b.isCheckbox&&"checkbox"==b.el.attr("type"))if(b.el.prop("checked"))b.setValue(d);else{var e=b.el.attr("data-unchecked");b.setValue("undefined"==typeof e?"":e)}else b.isCheckbox&&"radio"==b.el.attr("type")?(b.setValue(d),a.el.find("[name="+b.el.attr("name")+"]").not(b.el).each(function(){var b=r(this),c=b.attr("data-unchecked"),b=b.attr("data-cell");a.cells[b].setValue("undefined"==
