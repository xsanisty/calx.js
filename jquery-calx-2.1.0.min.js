...
function(a){return a.constructor.prototype});var G={autoCalculate:!0,autoCalculateTrigger:"blur",onBeforeCalculate:null,onAfterCalculate:null,onBeforeRender:null,onAfterRender:null,defaultFormat:!1,ajaxUrl:null,ajaxMethod:"get",graphHandler:"flot",checkCircularReference:!1},e={custom:{},date:{DATE:function(a,b,c){return"undefined"==typeof h?m.ERRKEY.momentRequired:"undefined"==typeof b?h(a):new Date(a,b-1,c)},DATEDIFF:function(a,b,c){return"undefined"==typeof h?m.ERRKEY.momentRequired:h(b).diff(h.utc(a),
...
delete s.sheetRegistry[b])});return this},reset:function(){return this.each(function(){var a=r(this).attr("data-calx-identifier");a&&"undefined"!=typeof s.sheetRegistry[a]&&s.sheetRegistry[a].reset()})},calculate:function(){return this.each(function(){var a=r(this).attr("data-calx-identifier");a&&"undefined"!=typeof s.sheetRegistry[a]&&s.sheetRegistry[a].calculate()})},setValue:function(a,b){var c=r(this).attr("data-calx-identifier"),c=s.sheetRegistry[c];c.getCell(a).setValue(b).renderComputedValue();
c.config.autoCalculate&&c.calculate()}};r.fn.calx=function(a,b){if(s[a])return s[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"==typeof a||"undefined"==typeof a)return s.init.apply(this,arguments);r.error("Method "+a+" does not exist on jQuery.calx")}})(jQuery,numeral,moment,jStat);
